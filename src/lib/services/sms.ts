...
export const SMSTemplates = {
  abandoned: (customerName: string, cartTotal: number, cartUrl: string) => `
Hi ${customerName || 'there'}! You left some great items in your cart.
Complete your order now: ${cartUrl}
Total: $${cartTotal.toFixed(2)}
  `.trim(),

  withDiscount: (customerName: string, cartTotal: number, discountCode: string, discountPercent: number, cartUrl: string) => `
