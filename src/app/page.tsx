        ...
        <div className="w-full max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-blue-100 max-w-2xl mx-auto">
              Multi-channel notifications bring customers back — and when they return, the AI bargain tab turns &ldquo;too expensive&rdquo; into &ldquo;sold&rdquo;.
            </p>
          </div>
          ...
          {/* The Bargain Tab — cream of the bargain system, woven into recovery */}
          <div className="relative rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-slate-900 via-blue-950/60 to-slate-900 overflow-hidden mb-8">
