        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-blue-300/80">
              ...
              <p className="flex items-start space-x-2">
                <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                <span>Campaign limits: <strong className="text-white">{PLANS.FREE.maxCampaigns} Free</strong> / <strong className="text-white">{PLANS.GROWTH.maxCampaigns} Growth</strong> / <strong className="text-white">{PLANS.PRO.maxCampaigns} Pro</strong> active campaigns</span>
              </p>
              <p className="flex items-start space-x-2">
                <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
