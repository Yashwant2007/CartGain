          ...
          <div className="space-y-8 text-blue-100">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>Informal Resolution:</strong> Before filing any claim, you agree to attempt to resolve the dispute informally by contacting us at <a href="mailto:legal@cartgain.io" className="text-cyan-400 hover:underline">legal@cartgain.io</a>.</li>
            ...
            <section className="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border border-cyan-700/40 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <p><strong>Email:</strong> <a href="mailto:legal@cartgain.io" className="text-cyan-400 hover:underline">legal@cartgain.io</a></p>
